...
K8S_THEME_PROMPT_COLOR=161
K8S_CHAR=${POWERLINE_K8S_CHAR:="⚓ "}

AWS_THEME_PROMPT_COLOR=124
AWS_CHAR=${POWERLINE_AWS_CHAR:="🌩 "}

TFENV_THEME_PROMPT_COLOR=30
...
POWERLINE_PROMPT=${POWERLINE_PROMPT:="user_info clock tfenv scm python_venv ruby cwd kubectl"}
